...
function songSet (players, folder = 'base') {
  ...
  songsArray = shuffle(songsArray) //перетасовка
  songsArray.sort(function(a, b) { //сортировка
  ...
  newRandSong.name0 = songsArray[0].name
  newRandSong.name1 = songsArray[1].name
  newRandSong.name2 = songsArray[2].name
  newRandSong.name3 = songsArray[3].name

  songsArray[0].frequency = songsArray[0].frequency + 1
  songsArray[1].frequency = songsArray[1].frequency + 1
  songsArray[2].frequency = songsArray[2].frequency + 1
  songsArray[3].frequency = songsArray[3].frequency + 1

  newRandSongResultNum = Math.floor(Math.random() * 4)

  let rightSong = songsArray[newRandSongResultNum]
